...
const Nyayabot: React.FC<NyayabotProps> = ({ t, messages, setMessages, currentUser }) => {
    ...
    return (
        <AnimatedPageWrapper>
            <div className="flex h-full w-full max-w-full gap-0 overflow-hidden bg-gray-900">
                ...
                <div className="flex-1 flex flex-col h-full overflow-hidden relative bg-gray-900">
                    ...
                    <div ref={chatContainerRef} className="flex-1 px-4 sm:px-8 pb-4 overflow-y-auto space-y-6 custom-scrollbar scroll-smooth">
                        {messages.map((msg, index) => (
                            <div key={index} className={`flex items-start gap-4 ${msg.role === 'user' ? 'justify-end' : 'justify-start'} group`}>
                                ...
                                <div className={`px-6 py-4 rounded-[20px] max-w-2xl shadow-sm transition-all ${msg.role === 'user' ? 'bg-blue-600 text-white rounded-br-none shadow-blue-500/20' :
                                    msg.role === 'model' ? 'bg-gray-800 text-gray-100 rounded-bl-none border border-gray-700 shadow-none' :
                        ...
                        {isLoading && (
                            <div className="flex items-start gap-4 justify-start">
                                ...
                                <div className="p-4 rounded-2xl rounded-bl-none bg-gray-800 border border-gray-700 shadow-sm">
                                    <Spinner />
                                </div>
                            </div>
                        )}
                    ...
                    <div className="p-6 pt-2 bg-gradient-to-t from-gray-900 via-gray-900 to-transparent z-10">
                            ...
                            <div className="mb-4 flex flex-wrap gap-2 justify-center">
                                {[
                                    ...
                                    <button
                                        ...
                                        className="text-xs bg-gray-800 text-gray-300 px-3 py-2 rounded-full border border-gray-700 hover:border-blue-400 hover:bg-blue-900/20 transition-all flex items-center gap-2 shadow-sm"
                                    >
                        ...
                        <form onSubmit={handleSubmit} className="relative flex items-center gap-2 p-2 bg-gray-800 rounded-2xl shadow-xl shadow-black/30 border border-gray-700">
                            ...
                            <input
                                ...
                                className="flex-1 p-2 bg-transparent border-none focus:ring-0 text-gray-100 placeholder-gray-500 text-base"
                            />
